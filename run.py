...
#    optimize_multiple(scenario, 100, seeds=[0], functions={'forest': forest_minimize}, verb=True)
...
#    optimize_multiple(scenario, 25, seeds=[0], functions={'forest': forest_minimize}, verb=True)
